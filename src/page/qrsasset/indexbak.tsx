...
const QrCodeAsset: React.FC<HomeScreenProps> = ({navigation}) => {
  ...
  const onSuccess = (e: {data: any}) => {
    ...
    setTimeout(() => {
      Linking.openURL('https://aset.transjakarta.co.id/data/' + e.data);
      setIsScanned(false);
    }, 800);
  };
